<? wp_footer() ?>
        ...
        <footer class="d-flex flex-column bg-dark lightGrey ">
            ...
            <div class="d-flex align-items-stretch p-3 flex-wrap">
                ...
                <div class="contactFooter d-flex flex-column p-4 col">
                    ...
                    <div class="d-flex align-items-center "> 
                        ...
                        <p class="m-0"> Odevdesign.studio@gmail.com</p>
                    </div>

                </div>
                <div class="instagrammFooter d-flex flex-column p-4 col ">
                    <h6 class="text-white ">Instagram</h6>
                    <div class="d-flex ">
                        <img src="./wp-content/themes/dev-restaurant/assets/images/burger-1.jpg" alt=""  class=" m-1 imgFooterSize">
                        <img src="./wp-content/themes/dev-restaurant/assets/images/burger-1.jpg" alt="" class=" m-1 imgFooterSize">
                        <img src="./wp-content/themes/dev-restaurant/assets/images/burger-1.jpg" alt="" class=" m-1 imgFooterSize">
                    </div>
                    <div class="d-flex ">
